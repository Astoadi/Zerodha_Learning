  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <p className="mt-5" style={{ fontSize: "0.75rem", color: "#808080" }}>
    ...
    <div className="d-flex justify-content-sm-center justify-content-sm-around text-nowrap flex-wrap" style={{padding:"0 11rem 1.25rem 11rem",fontSize:"1rem",color:"#808080"}}>
      <a href="">NSE</a>
      <a href="">BSE</a>
